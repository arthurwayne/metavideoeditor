...
namespace WizardBase
{
    ...
    public class StartStep : WizardStep
    {
        ...
        private ColorPair leftPair = new ColorPair(Color.FromArgb(191, 219, 255), Color.White, 270);
...
#pragma warning disable DoNotCallOverridableMethodsInConstructor
            ...
            Icon = global::MetaVideoEditor.Properties.Resources.wizard_icon;
            BindingImage = global::MetaVideoEditor.Properties.Resources.wizard_left;
...
#pragma warning restore DoNotCallOverridableMethodsInConstructor
        ...
        {
            ColorPair pa = new ColorPair(Color.FromArgb(191, 219, 255), Color.White, 270);
            return false;// leftPair != pa;
        }

        private void ResetLeftPair()
        {
            leftPair = new ColorPair(Color.FromArgb(191, 219, 255), Color.White, 270);
        }

        protected virtual bool ShouldSerializeBindingImage()
        {
            return  BindingImage != global::MetaVideoEditor.Properties.Resources.wizard_left;
        }
        ...
        {
            return Icon != global::MetaVideoEditor.Properties.Resources.wizard_icon;
        }
