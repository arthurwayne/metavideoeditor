...
namespace SettingsStyle
{
    ...
    public class TabPageSwitcher : ContainerControl {
        private PanelPage selectedPanelPage;
        ...
        /// </summary>
        public PanelPage SelectedPanelPage {
            get { return selectedPanelPage; }
            set {
                if (selectedPanelPage != value) {
                    
                    selectedPanelPage = value;
                   
                    if (selectedPanelPage != null) {
                        if (!Controls.Contains(value)) {
                            Controls.Add(selectedPanelPage);
                            
                        }
                        else {
                            selectedPanelPage.BringToFront();
        ...
        /// </summary>
        public event EventHandler SelectedPanelPageChanged;
        ...
        /// </summary>
        /// <param name="e"></param>
        protected virtual void OnSelectedPanelPageChanged(EventArgs e)
        {
            if (SelectedPanelPageChanged != null) {
                SelectedPanelPageChanged(this, EventArgs.Empty);
