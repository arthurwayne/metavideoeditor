...
namespace WizardBase
{
    ...
    public class IntermediateStep : WizardStep
    {
        ...
        private Image bindingImage = global::MetaVideoEditor.Properties.Resources.wizard_Top;
...
#pragma warning restore DoNotCallOverridableMethodsInConstructor
        ...
        {
            return bindingImage != global::MetaVideoEditor.Properties.Resources.wizard_Top;
        }

        protected virtual bool ShouldSerializeHeaderPair()
        {
            return false;// headerPair != new ColorPair();
        }
        ...
        {
            bindingImage = global::MetaVideoEditor.Properties.Resources.wizard_Top;
        }
