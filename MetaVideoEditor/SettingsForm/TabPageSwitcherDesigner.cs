    ...
    class TabPageSwitcherDesigner : ParentControlDesigner {
        ...
        public override System.ComponentModel.Design.DesignerVerbCollection Verbs {
            get {
                if (verbs == null) {
                    ...
                    verbs.Add(new DesignerVerb("Add Panel page", new EventHandler(this.OnAdd)));         
                }
        ...
        private void OnAdd(object sender, EventArgs eevent) {
            ...
            if (host != null) {
                ...
                try {
                    try {
                        t = host.CreateTransaction("Add Panel page" + Component.Site.Name);
                    }
                    ...
                    PanelPage page = host.CreateComponent(typeof(PanelPage)) as PanelPage;
                    ...
                    SetProperty("SelectedPanelPage", page);                    
                    ...
                    if (ControlSwitcher.TabStrip != null) {
                        ...
                        SetProperty(tab, "PanelPage", page);
        ...
        void SelectionService_SelectionChanged(object sender, EventArgs e) {
            ...
            if (selectedComponents.Count == 1) {
                ...
                if (tab != null) {
                    SetProperty("SelectedPanelPage", tab.PanelPage);
