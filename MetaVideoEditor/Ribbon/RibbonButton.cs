...
namespace RibbonStyle
{
    public partial class RibbonButton : System.Windows.Forms.Button
    {
        ...
        public int img_heigth
        {
            get { return _img_heigth; }
            set
            {
                _img_heigth = value;
            }
        ...
        private ToolStripItemCollection _menuItems;
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            if (this.Parent != null)
            {
                ...
                int X = (rect.Width - _img_heigth) / 2;// 4;
                try
                {
                    int newwidth = _img_heigth;// (rect.Width - 8);
                    
                    int newheigth = _img_heigth;// newwidth * _img.Height / _img.Width;
